                              ...
                              child: Row(
                                ...
                                children: [
                                  GestureDetector(
                                      ...
                                      child: (getRowButton('images/playEnd1x.png'))),
                                  GestureDetector(
                                      onTap: () {
                                        showDialog(
                                            context: context,
                                            builder: (context) =>
                                                CustomDialogPlayAll());},
                                      child: getRowButton('images/play_all_icon.png')),// images/play_all_icon.png
                                  getRowButton('images/search_icon.png'),//images/search_icon.png
                                  getRowButton('images/ayaList.png'),//images/ayaList.png
                                  getRowButton('images/list_icon.png'),
                                  getRowButton(
                                      ('images/bookmark_list_icon.png')),//images/bookmark_list_icon.png
                                  getRowButton('images/addBookMark_icon.png'),//images/addBookMark_icon.png
                                  getRowButton((('images/search_icon.png'))),//images/search_icon.png
                                ],
                              ))),
